 ...
 * @version 1.0
 */
public class TelefonoMemoria2 extends JFrame
{
    // Constantes
        ...
        boton.addActionListener(new ActionListener() {
                public void actionPerformed (ActionEvent e){
                    ...
                    if(!numTelefono.equals(MENSAJE_LLAMADA)){                    
                        //int digitoLoco = generarDigitoLoco(e.getActionCommand());
                        //display.setText(numTelefono + digitoLoco);
                        display.setText(numTelefono + e.getActionCommand());
                    }
                }
            });
    ...
    private void agregarBotonBorrar(Container panel, String textoBoton)
    {
        ...
        botonBorrar.setToolTipText("borra el último digito");
    ...
    private void agregarBotonLlamar(Container panel, String textoBoton)
    {
        ...
        boton.addActionListener(new ActionListener() {
                public void actionPerformed (ActionEvent e) {
                    ...
                    pilaLlamadas.push(numeroMarcado);
                }
            });
    }
